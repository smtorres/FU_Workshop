...
df.to_csv("[<<PATH TO A CSV FILE WHERE METADATA WILL BE STORED>>]", index=False)
...
for i, row in df.iterrows():
    ...
    image_id = row['id']
    if image_url:
        filename = f"<<FOLDER WHERE IMAGES WILL BE STORED>>/image_{i}.jpg"  # You can use a more descriptive filename
